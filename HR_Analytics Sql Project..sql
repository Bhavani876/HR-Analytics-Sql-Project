...
use hr_analytics;
SELECT * FROM hr_resources;

-- data cleaning and preprocessing--
ALTER TABLE hr_resources CHANGE COLUMN ï»¿id emp_id VARCHAR(30) NULL;

DESCRIBE hr_resources;
...
SELECT min(age), max(age) FROM hr_resources;
